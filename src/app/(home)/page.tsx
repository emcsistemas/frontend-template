        ...
        <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm text-zinc-500 dark:text-zinc-400">
              Atualize sua foto e outros detalhes do seu perfil.
            </span>
          </div>
      ...
      >
        ...
        <div className="grid gap-3 pt-5 lg:grid-cols-form">
          ...
          >
            ...
            <span className="text-sm font-normal text-zinc-500 dark:text-zinc-400">
              Esta foto será mostrada em seu perfil.
            </span>
          </label>
          <FileInput.Root
            id="photo"
        ...
        <label className="grid gap-3 pt-5 lg:grid-cols-form">
          ...
          <Select.Root name="timezone">
            <Select.Trigger>
              <Select.Value placeholder="Selecione a timezone..." />
            </Select.Trigger>
              ...
              <Select.Root defaultValue="normal">
                ...
                <Select.Content>
                  <Select.Item value="normal">
                    <Select.ItemText>Texto normal</Select.ItemText>
                  </Select.Item>
